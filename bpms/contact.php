      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5">
            <h2 class="mb-0 bread">Холбоо барих</h2>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php"> Нүүр хуудас <i class="ion-ios-arrow-forward"></i></a></span> <span> Холбоо барих <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
...
?>
          ...
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
          		...
          		<h3 class="mb-4">Утасны дугаар</h3>
