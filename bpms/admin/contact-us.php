...
$timing=$_POST['timing'];
    ...
    if ($query) {
    $msg="Холбоо барих хуудас шинэчлэгдсэн .";
  }
  else
    {
	...
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">Холбоо барих мэдээлэл шинэчлэх </h3>
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4> Холбоо барих мэдээлэл шинэчлэх:</h4>
						</div>
						<div class="form-body">
							<form method="post">
